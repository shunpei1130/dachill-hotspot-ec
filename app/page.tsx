...
function ModalBody({ id }: { id: string }) {
  ...
  if (id === "company") return <><p className="stamp">CLUB INFORMATION</p><h2>会社概要</h2><dl className="spec-list"><div><dt>屋号</dt><dd>DACHILL</dd></div><div><dt>代表者</dt><dd>長谷川峻平</dd></div><div><dt>所在地</dt><dd>販売開始前に記載</dd></div><div><dt>事業内容</dt><dd>生活雑貨の企画・販売、ブランド運営</dd></div></dl></>;
  ...
  if (id === "law") return <><p className="stamp">RECEIPT / LEGAL</p><h2>特定商取引法に基づく表記</h2><dl className="spec-list"><div><dt>販売事業者</dt><dd>DACHILL</dd></div><div><dt>運営責任者</dt><dd>長谷川峻平</dd></div><div><dt>所在地・電話番号</dt><dd>販売開始前に記載</dd></div><div><dt>販売価格</dt><dd>4,980円（税込・送料込み）</dd></div><div><dt>追加料金</dt><dd>商品代金以外なし（通信料金等はお客様負担）</dd></div><div><dt>支払方法・時期</dt><dd>クレジットカード／注文確定時</dd></div><div><dt>引渡時期</dt><dd>注文確定後3〜5営業日以内に発送</dd></div><div><dt>返品・交換</dt><dd>初期不良・誤配送は到着後7日以内に当店負担で対応。お客様都合は未使用・未開封に限り到着後8日以内、返送料はお客様負担。</dd></div></dl><p className="note">現在は販売前のプロトタイプです。所在地・電話番号・連絡先は販売開始前に確定します。</p></>;
